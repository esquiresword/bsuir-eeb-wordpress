          ...
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              hls.on(window.Hls.Events.MANIFEST_PARSED, function (event, data) {
                ...
                var player = new prestoActionBar_prestoActionBarController_prestoActionBarUi_prestoBunny_prestoCtaOverlay_prestoCtaOverlayController_prestoCtaOverlayUi_prestoDynamicOverlayUi_prestoDynamicOverlays_prestoEmailOverlay_prestoEmailOverlayController_prestoEmailOverlayUi_prestoMutedOverlay_prestoPlayer_prestoPlayerButton_prestoPlayerSpinner_prestoVideo_prestoVimeo_prestoYoutube_prestoYoutubeSubscribeButton_entry.PrestoPlayer(selector, index._objectSpread2({}, config));
            ...
            case 14:
              return _context.abrupt("return", resolve(new prestoActionBar_prestoActionBarController_prestoActionBarUi_prestoBunny_prestoCtaOverlay_prestoCtaOverlayController_prestoCtaOverlayUi_prestoDynamicOverlayUi_prestoDynamicOverlays_prestoEmailOverlay_prestoEmailOverlayController_prestoEmailOverlayUi_prestoMutedOverlay_prestoPlayer_prestoPlayerButton_prestoPlayerSpinner_prestoVideo_prestoVimeo_prestoYoutube_prestoYoutubeSubscribeButton_entry.PrestoPlayer(selector, index._objectSpread2({}, config))));
